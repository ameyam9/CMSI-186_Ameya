public class CountTheDays  {
    public static void main(String args[]) {
        try {
            if(args.length < 6) {
                System.out.println( "Not Enough Arguments Used!" );
                System.exit( 0 );
            }
            ...
            if(!(CalendarStuff.isValidDate(month1, day1, year1)) || !(CalendarStuff.isValidDate(month2, day2, year2))) {
                System.out.println("Invalid Date, Cannot be Used");
                System.exit(-1);

            }else {
                System.out.println("Days between dates are" + " " +CalendarStuff.daysBetween(month1, day1, year1, month2, day2, year2) );
            }
        }
